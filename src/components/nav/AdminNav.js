...
const AdminNav = () => (
    <nav>
        <ul className='nav flex-column'> 
            ...
            <li className='nav-item'><Link className="nav-link" to="/admin/sub">Sub Category</Link></li>
            <li className='nav-item'><Link className="nav-link" to="/admin/coupon">Coupon</Link></li>
